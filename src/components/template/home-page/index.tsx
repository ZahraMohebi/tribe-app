...
import { useAuthMember, usePosts, useSpaces } from "@tribeplatform/react-sdk/hooks";
import { simplifyPaginatedResult } from "@tribeplatform/react-sdk/utils";
import FollowerCard from "../../molecule/follower-card";
import PostCard from "../../molecule/post-card";
import Tabs from "../../molecule/tab-slide";
...
const HomePage = () => {
  ...
  const { data: spaces, isLoading:loadSpace } = useSpaces();
  const {
    data: posts,
    isLoading,
    fetchNextPage,
